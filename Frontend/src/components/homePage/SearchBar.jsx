  ...
  return (
    <div className={`${styles.paddingX}`}>
      <div className="flex flex-col items-center rounded-3xl shadow-lg bg-white pb-[40px] ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5 border-2 border-gray-400 sm:rounded-3xl md:rounded-3xl lg:rounded-full gap-5 w-[95%] p-3 px-5 text-[18px]">
          <div
